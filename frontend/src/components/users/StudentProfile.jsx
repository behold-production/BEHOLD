      ...
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            const Icon = kpi.icon;
            return (
              <div key={i} className="bg-white/75 backdrop-blur-md border-[1.5px] border-[#0b1424] shadow-dark-blue-sm hover:shadow-dark-blue rounded-lg sm:rounded-xl p-4 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {/* C-DAT card */}
          <div className="bg-white/75 backdrop-blur-md border-[1.5px] border-[#0b1424] shadow-dark-blue hover:shadow-dark-blue-hover rounded-lg sm:rounded-xl p-5 transition-all duration-300 hover:-translate-y-1">
        ...
        <div className="space-y-3.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="relative bg-white border-[1.5px] border-[#0b1424] p-5 rounded-lg sm:rounded-xl shadow-dark-blue hover:shadow-dark-blue-hover transition-all duration-300 flex flex-col justify-between space-y-4 hover:-translate-y-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          {/* Recent activity */}
          <div className="lg:col-span-2 bg-white/75 backdrop-blur-md border-[1.5px] border-[#0b1424] shadow-dark-blue rounded-lg sm:rounded-xl p-5">
          ...
          {/* Achievements */}
          <div className="bg-white/75 backdrop-blur-md border-[1.5px] border-[#0b1424] shadow-dark-blue rounded-lg sm:rounded-xl p-5">
