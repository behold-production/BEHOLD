        ...
        <div className="min-h-screen bg-zinc-955 text-white flex flex-col items-center justify-center p-4 relative overflow-hidden select-none font-sans text-left">
          ...
          <div className="max-w-xl w-full relative z-10 space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 p-6 rounded-[10px] shadow-2xl space-y-4">
              <div>
                <span className="text-xs tracking-widest text-zinc-500 font-semibold block mb-1">Error Diagnostics</span>
                <p className="text-sm font-semibold text-rose-450 break-all leading-normal">
              ...
              {this.state.errorInfo && (
                <div className="space-y-1.5">
                  <span className="text-xs tracking-widest text-zinc-500 font-semibold block">Component Callstack</span>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <button
                ...
                className="px-8 py-3.5 bg-brand hover:bg-[#00cce6] text-zinc-950 font-semibold text-xs tracking-widest rounded-full transition-all cursor-pointer flex items-center justify-center gap-2 border-none shadow-[0_0_15px_rgba(0,229,255,0.4)] w-full sm:w-auto hover:scale-[1.03] active:scale-[0.97]"
              >
              ...
              <button
                ...
                className="px-8 py-3.5 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold text-xs tracking-widest rounded-full transition-all cursor-pointer flex items-center justify-center gap-2 border border-zinc-700 w-full sm:w-auto hover:scale-[1.03] active:scale-[0.97]"
              >
