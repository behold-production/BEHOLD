          ...
          <div className="max-w-xl w-full relative z-10 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
              <button
                ...
                className="px-8 py-3.5 bg-brand hover:bg-[#00cce6] text-zinc-950 font-semibold text-xs tracking-widest rounded-xl transition-all cursor-pointer flex items-center justify-center gap-2 border-none shadow-[0_0_15px_rgba(0,229,255,0.4)] w-full sm:w-auto hover:scale-[1.03] active:scale-[0.97]"
              >
