        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {PILLARS.map((pillar, idx) => {
            return (
              <div
                key={idx}
                className="bg-white hover:bg-zinc-50/70 border-[1.5px] border-[#0b1424] rounded-lg lg:rounded-2xl p-5 sm:p-6 shadow-dark-blue hover:shadow-dark-blue-hover transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between group font-sans"
              >
