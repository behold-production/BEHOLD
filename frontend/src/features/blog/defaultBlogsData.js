...
export const DEFAULT_BLOGS_DATA = [
  {
    ...
    content: `
      ...
      <p>Data is the new oil. From fintech to healthcare, organisations rely on data scientists and AI engineers to make predictive decisions. Students with a logical mindset thrive in these environments.</p>
      
      <h3>2. UX/UI & Product Design</h3>
      <p>Every business lives on mobile screens. User experience designers bridge human psychology and digital interfaces, creating intuitive software products.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>Parents should focus on praising effort rather than outcome. A calm home atmosphere directly elevates student self-esteem and focus.</p>
    `
  }
];
