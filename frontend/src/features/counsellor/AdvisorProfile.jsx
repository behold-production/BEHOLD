...
export default function AdvisorProfile({ advisorId, onBack, onBook }) {
 ...
 type="button"
 onClick={onBack}
 className="absolute top-20 md:top-32 left-4 md:left-10 z-10 min-h-[44px] flex items-center gap-2 px-4 py-2.5 bg-surface-900 hover:bg-surface-800 text-white rounded-full text-[10px] font-black tracking-widest transition-all cursor-pointer shadow-none"
 >
 ...
 {/* Profile Card Main */}
 <div className="bg-white rounded-[10px] shadow-square-light border border-surface-200 p-4.5 sm:p-6 md:p-10 relative overflow-hidden">
 ...
 <span className="px-3 py-1 bg-surface-900 text-white text-[10px] font-black tracking-widest rounded-[10px]">
 Verified Expert
 </span>
 <span className="flex items-center gap-1 text-xs sm:text-xs font-bold text-zinc-500 ">
 ...
 <h1 className="text-2xl sm:text-3xl md:text-5xl font-header font-black text-zinc-900 tracking-tight leading-none ">
 {advisor.name}
 </h1>
 ...
 <span className="text-xs text-zinc-500 font-bold mb-1">Therapy Hours</span>
 ...
 <div className="flex flex-col">
 <span className="text-xs text-zinc-500 font-bold mb-1">Languages</span>
 <span className="flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-zinc-900">
 ...
 <div className="w-px h-8 bg-zinc-200" aria-hidden="true"></div>
 <div className="flex flex-col">
 <span className="text-xs text-zinc-500 font-bold mb-1">Session Fee</span>
 ...
 <h3 className="text-sm sm:text-lg font-bold tracking-wide">About {advisor.name.split(' ')[0]}</h3>
 </div>
 ...
 {/* Specializations */}
 <div className="bg-white p-5 sm:p-6 md:p-8 rounded-[10px] border border-surface-200 shadow-square-light space-y-5">
 <div className="flex items-center gap-2 text-zinc-900">
 <Heart className="w-5 h-5 text-brand" />
 <h3 className="text-sm sm:text-lg font-bold tracking-wide">Core Specialties</h3>
 </div>
 <div className="flex flex-wrap gap-3">
 {advisor.specialties.map((spec, i) => (
 <div key={i} className="px-4 py-2 bg-surface-50 border border-surface-200 rounded-[10px]">
 <span className="text-[10px] font-black tracking-widest text-surface-900">{spec}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <h3 className="text-sm sm:text-lg font-bold tracking-wide">Qualifications</h3>
 </div>
 <div className="flex items-start gap-4 p-4 border border-surface-200 rounded-[10px] bg-surface-50 shadow-square-light">
 <div className="w-10 h-10 rounded-[10px] bg-white border border-surface-200 flex items-center justify-center shrink-0 text-surface-600">
 ...
 <div>
 <h3 className="text-lg sm:text-xl font-bold text-zinc-900 tracking-wide mb-1">Book a Session</h3>
 ...
 className="min-h-[48px] w-full py-3.5 bg-surface-900 hover:bg-surface-800 text-white rounded-[10px] text-[10px] font-black tracking-widest shadow-none transition-all flex items-center justify-center gap-2 cursor-pointer border-none"
 >
