...
export default function RevenueTab(props) {
 ...
 <span className="text-[10px] font-bold text-zinc-500 block">Razorpay Merchant Account ID</span>
 ...
 <div className="space-y-1">
 <span className="text-[10px] font-bold text-zinc-500 block">Account Routing Number</span>
 <span className="text-xs font-mono font-semibold text-white">
