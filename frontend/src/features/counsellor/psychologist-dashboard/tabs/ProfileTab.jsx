 ...
 * Coordinates are required. Please select a search result or use "Detect My Location".
 ...
 <span className="text-sm text-emerald-450 font-bold flex items-center gap-1 bg-emerald-955/20 px-3 py-1.5 rounded-[10px] border border-emerald-900/30">Connected ✅</span>
 <button
 type="button"
 onClick={async () => {
