...
const ProfileTab = ({
 ...
 <h3 className="text-sm font-bold text-zinc-500 font-header">Consultant Psychologist Profile</h3>
 ...
 <label className="text-zinc-400 font-bold text-xs tracking-wide">Display Name</label>
 <input
 type="text"
 ...
 <div className="space-y-1.5">
 <label className="text-zinc-400 font-bold text-xs tracking-wide">Session Fee (INR / Hour)</label>
 <input
 type="number"
 placeholder="1200"
 value={ep.price || ''}
 ...
 <div className="space-y-1.5">
 <label className="text-zinc-400 font-bold text-xs tracking-wide">Languages Spoken</label>
 <input
 type="text"
 ...
 <div className="sm:col-span-2 space-y-1.5">
 <label className="text-zinc-400 font-bold text-xs tracking-wide">Default Google Meet Link</label>
 <input
 type="url"
 ...
 * Coordinates are required. Please select a search result or use "Detect My Location".
 ...
 className="px-3.5 py-2 bg-zinc-950 hover:bg-zinc-850 border border-zinc-800 text-zinc-305 text-xs font-bold rounded-full transition cursor-pointer flex items-center justify-center gap-1.5 disabled:opacity-50"
 >
 {isLocating ? (
 <>
 ...
 <label className="text-zinc-400 font-bold text-xs tracking-wide block">Supported Session Modes</label>
 ...
 {profile?.googleRefreshToken ? (
  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
    ...
    <div className="flex items-center gap-2.5 bg-emerald-955/10 border border-emerald-900/30 px-3 py-2 rounded-[10px]">
      ...
      <div className="text-left">
        ...
        {!profile?.googleEmail && !profile?.googleName && (
          <p className="text-xs text-emerald-450 font-bold">Connected ✅</p>
        )}
      </div>
    </div>
    <button
      ...
      className="px-3.5 py-1.5 bg-rose-955/20 text-rose-500 hover:bg-rose-900 border border-rose-900/30 text-xs font-bold rounded-[10px] transition cursor-pointer"
    >
      Disconnect
    </button>
  </div>
 ...
 className="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 text-xs font-bold rounded-[10px] transition cursor-pointer shadow-sm flex items-center gap-2"
 >
 ...
 <span className="text-xs font-bold tracking-wider text-zinc-450">
 {!isNotificationSupported()
 ? 'Not Supported'
 : permissionState === 'granted'
 ? 'Active / Enabled'
