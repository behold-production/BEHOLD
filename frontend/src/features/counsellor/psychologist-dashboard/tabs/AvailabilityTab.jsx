      ...
      <div className="space-y-6 text-left font-medium p-5 rounded-xl transition-all" style={shadowStyle}>
        ...
        <div className="space-y-3 pt-5 border-t border-zinc-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              return (
                <div key={slot} className="flex items-center gap-2 w-full group">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2.5 bg-zinc-950 border border-zinc-800 hover:bg-rose-955/20 hover:border-rose-900 text-zinc-400 hover:text-rose-400 rounded-lg text-sm font-bold capitalize transition-colors cursor-pointer shrink-0 opacity-0 group-hover:opacity-100"
                    title="Remove Slot"
                  >
                    Remove
                  </button>
            ...
            {allSlots.length === 0 && (
              <div className="col-span-1 sm:col-span-2 py-5 bg-zinc-950/40 border border-dashed border-zinc-800 rounded-xl text-zinc-500 italic text-sm text-center w-full">
          ...
          <div className="flex gap-2 items-end max-w-sm">
            <div className="flex-1 space-y-1.5">
              ...
              <select
                ...
                className="w-full px-2.5 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-sm text-white outline-none focus:border-brand cursor-pointer"
              >
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <select
                ...
                className="w-full px-2.5 py-2 bg-zinc-955 border border-zinc-800 rounded-lg text-sm text-white outline-none focus:border-brand cursor-pointer"
              >
            ...
            <button
              ...
              className="bg-brand hover:bg-brand-dark text-zinc-955 px-4 py-2 text-sm font-bold capitalize rounded-lg transition-colors cursor-pointer shrink-0 h-[38px] flex items-center justify-center shadow-sm border-none"
            >
              Add Slot
            </button>
          </div>
        ...
        <div className="space-y-3 pt-5 border-t border-zinc-800">
          ...
          <div className="flex flex-col gap-3 max-w-sm p-4 bg-zinc-950/40 border border-zinc-800 rounded-xl">
            <div className="flex gap-2 items-end">
              ...
              <div className="flex-1 space-y-1">
                <select
                  ...
                  className="w-full px-2.5 py-2 bg-zinc-950 border border-zinc-800 rounded-lg text-sm text-white outline-none focus:border-brand cursor-pointer shadow-sm"
                >
                  {['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'].map(h => (
                    <option key={h} value={h}>{h}</option>
                  ))}
            ...
            <button
              ...
              className="w-full mt-2 bg-zinc-900 hover:bg-zinc-800 text-white py-2.5 text-sm font-bold capitalize rounded-lg transition-colors border border-zinc-800 cursor-pointer flex items-center justify-center shadow-sm"
            >
        ...
        <div className="pt-6 border-t border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-4">
          {isAvailabilitySaved ? (
            <span className="text-sm text-emerald-450 font-bold capitalize flex items-center gap-1 bg-emerald-955/20 px-3 py-1.5 rounded-lg border border-emerald-900/30">
              Availability Matrix Synchronized!
            </span>
          ) : <span />}
          <button
            type="submit"
            className="w-full sm:w-auto bg-brand hover:bg-brand-dark text-zinc-955 px-8 py-2.5 text-sm font-bold capitalize rounded-lg shadow-sm border-none cursor-pointer flex items-center justify-center gap-2 transition-colors"
          >
