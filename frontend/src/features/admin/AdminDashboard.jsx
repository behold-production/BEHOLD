...
export default function AdminDashboard({ setView }) {
 ...
 {loginError && (
 <p className="text-sm text-rose-500 font-bold tracking-wide ">{loginError}</p>
 )}
 <button
 type="submit"
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">Time Slot</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">Booking Status</label>
 <select
 ...
 {bookingFormError && (
 <p className="text-sm text-rose-500 font-bold tracking-wide">{bookingFormError}</p>
 )}

 {bookingFormSuccess && (
 <p className="text-sm text-emerald-500 font-bold tracking-wide">{bookingFormSuccess}</p>
 )}
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">FAQ Question</label>
 <input
 type="text"
 required
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">Detailed Answer</label>
 <textarea
 rows={5}
 required
 ...
 {faqFormError && (
 <p className="text-sm text-rose-500 font-bold tracking-wide">{faqFormError}</p>
 )}

 {faqFormSuccess && (
 <p className="text-sm text-emerald-500 font-bold tracking-wide">{faqFormSuccess}</p>
 )}
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">Category / Domain</label>
 <select
 ...
 <div className="space-y-1">
 <label className="text-sm font-bold text-zinc-400">Question Text</label>
 <textarea
 rows={3}
 required
 ...
 {aptitudeFormError && (
 <p className="text-sm text-rose-500 font-bold tracking-wide">{aptitudeFormError}</p>
 )}

 {aptitudeFormSuccess && (
 <p className="text-sm text-emerald-500 font-bold tracking-wide">{aptitudeFormSuccess}</p>
 )}
 ...
 <div className="space-y-3">
 <label className="text-sm font-bold text-zinc-400 block">Assigned Scopes</label>
 ...
 {editSubAdminError && (
 <p className="text-sm text-rose-500 font-bold tracking-wide">{editSubAdminError}</p>
 )}

 {editSubAdminSuccess && (
 <p className="text-sm text-emerald-500 font-bold tracking-wide">{editSubAdminSuccess}</p>
 )}
