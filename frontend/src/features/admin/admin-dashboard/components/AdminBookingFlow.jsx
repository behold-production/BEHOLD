              ...
              {paymentStatus === 'PAYMENT_PENDING' ? (
                <>
                  ...
                  <button 
                    ...
                    className="flex items-center space-x-2 px-6 py-2.5 bg-[#25D366] hover:bg-[#128C7E] text-slate-900 font-semibold rounded-xl transition shadow-md hover:shadow-lg"
                  >
                    <Share2 size={18} />
                    <span>Share Payment Link via WhatsApp</span>
                  </button>

                  <div className="w-full flex flex-col items-center p-4 bg-whitember-50 rounded-xl border border-amber-200">
                  ...
                  <div className="w-full pt-4 border-t border-gray-200 space-y-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="px-5 py-2 bg-teal-700 hover:bg-teal-800 text-slate-900 text-sm font-semibold rounded-xl disabled:opacity-50 transition shadow-sm"
                      >
                ...
                <div className="flex flex-col items-center py-8 text-center space-y-4">
                  ...
                  <button 
                    ...
                    className="mt-4 px-8 py-3 bg-[#00e5ff] text-slate-900 font-bold hover:bg-[#00b2be] transition-colors shadow-sm hover:scale-105 border-none font-semibold rounded-xl transition shadow-md"
                  >
        ...
        {step === 1 && (
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-[#00e5ff] text-slate-900 font-bold hover:bg-[#00b2be] transition-colors shadow-sm hover:scale-105 border-none font-semibold rounded-xl shadow-md disabled:opacity-50 flex items-center text-sm transition"
            >
