...
export default function PsychologistManagementTab(props) {
 ...
 <div>
 <h3 className="text-sm font-bold text-white font-header">Psychologists Directory</h3>
 ...
 <button onClick={() => handleExportPDF('counsellors-table', 'Psychologists_Directory')} className="px-3 py-2 border border-zinc-800 hover:bg-zinc-850 hover:text-white text-zinc-400 text-sm font-bold rounded-lg transition-colors cursor-pointer shrink-0">
 Export PDF
 </button>
 <button onClick={() => handleExportImage('counsellors-table', 'Psychologists_Directory')} className="px-3 py-2 border border-zinc-800 hover:bg-zinc-850 hover:text-white text-zinc-400 text-sm font-bold rounded-lg transition-colors cursor-pointer shrink-0">
 Export Image
 </button>
 {canAddPsy && (
 <button
