...
export default function BookingManagementTab(props) {
 ...
 <span className="text-sm text-zinc-500 font-bold block">Estimated Revenue</span>
 ...
 <td className="p-3 text-center whitespace-nowrap">
 <span className={`inline-flex items-center px-2 py-0.5 rounded text-sm font-bold ${booking.status === 'CONFIRMED'
