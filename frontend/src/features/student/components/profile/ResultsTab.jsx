...
const ResultsTab = ({
 ...
 <div>
 <h2 className="text-xl font-semibold text-surface-900 tracking-tight">Aptitude Test Results</h2>
 ...
 <p className="text-sm font-semibold tracking-widest text-surface-900">No Sample Test History</p>
 ...
 <span className="text-[10px] tracking-widest font-semibold px-2.5 py-1 bg-white/10 rounded-[10px]">
 ...
 <p className="text-[10px] font-semibold text-surface-500 tracking-widest">Top Strength Domains</p>
 {scores.slice(0, 4).map(([key, pct]) => (
 <div key={key} className="space-y-1">
 <div className="flex justify-between tracking-widest font-semibold text-[10px]">
 ...
 type="button"
 onClick={() => navigate('/sample-test')}
 className="w-full mt-2 inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-surface-200 hover:border-surface-300 text-surface-900 tracking-widest text-[10px] font-semibold rounded-[10px] hover:bg-surface-50 transition-colors bg-white cursor-pointer"
 >
 ...
 <div className="bg-white border border-surface-200 rounded-[10px] shadow-square-light p-5">
 <h3 className="text-sm font-semibold text-surface-900 mb-1 flex items-center gap-2">
 ...
 <span className="text-[10px] tracking-widest font-semibold text-surface-900">{career}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 {/* Upload form */}
 <div className="bg-white border border-surface-200 rounded-[10px] shadow-square-light p-5">
 <h3 className="text-base font-semibold text-surface-900 mb-1.5 flex items-center gap-2">
 ...
 <div>
 <label className="text-[10px] tracking-widest font-semibold text-surface-600 block mb-1">
 ...
 required
 className="w-full text-sm font-medium text-surface-900 file:mr-3 file:py-1.5 file:px-3 file:rounded-[10px] file:border-0 file:text-[10px] file: file:tracking-widest file:font-semibold file:bg-surface-200 file:text-surface-900 hover:file:bg-surface-300 file:cursor-pointer p-2 border border-surface-200 rounded-[10px] bg-surface-50 focus:outline-none"
 />
 <p className="text-[10px] font-semibold tracking-widest text-surface-400 mt-1">Allowed formats: JPG, JPEG, PNG, PDF (Max 5MB)</p>
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <label className="text-[10px] tracking-widest font-semibold text-surface-600 block mb-1">Date Taken</label>
 <input
 type="date"
 value={cigiDate}
 ...
 <div>
 <label className="text-[10px] tracking-widest font-semibold text-surface-600 block mb-1">Time Taken</label>
 <input
 type="time"
 value={cigiTime}
 ...
 <div>
 <label className="text-[10px] tracking-widest font-semibold text-surface-600 block mb-1">Remarks / Note</label>
 <textarea
 ...
 <p className="text-[10px] font-semibold tracking-widest">No result files uploaded yet.</p>
 </div>
 ) : (
 ...
 <span className={`text-[10px] px-1.5 py-0.5 rounded-[10px] font-semibold ${result.fileType === 'pdf' ? 'bg-rose-100 text-rose-700' : 'bg-blue-100 text-blue-700'}`}>
 {result.fileType}
 </span>
 {(result.testDate || result.testTime) && (
 <span className="text-[10px] text-surface-500 font-semibold tracking-widest">
 ...
 <p className="text-[10px] text-surface-400 font-semibold tracking-widest mt-0.5">
