            ...
            {!testProfile ? (
              <div className="bg-surface-50 border border-dashed border-surface-300 rounded-none p-8 text-center">
                ...
                <button
                  ...
                  className="mt-4 inline-flex items-center gap-1.5 px-5 py-2 bg-surface-900 text-white uppercase tracking-widest text-[10px] font-black rounded-none hover:bg-surface-800 transition-colors border-none shadow-none"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="bg-surface-900 rounded-none p-5 text-white">
                  ...
                  <div className="mt-3.5 flex justify-between items-center">
                    <span className="text-[10px] uppercase tracking-widest font-black px-2.5 py-1 bg-white/10 rounded-none">
                  ...
                  {scores.slice(0, 4).map(([key, pct]) => (
                    <div key={key} className="space-y-1">
                      ...
                      <div className="h-1.5 w-full bg-surface-100 rounded-none overflow-hidden">
                        <div className="h-full bg-surface-900 rounded-none" style={{ width: `${pct}%` }} />
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <button
                  type="button"
                  onClick={() => navigate('/sample-test')}
                  className="w-full mt-2 inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-surface-200 hover:border-surface-300 text-surface-900 uppercase tracking-widest text-[10px] font-black rounded-none hover:bg-surface-50 transition-colors bg-white cursor-pointer"
                >
            ...
            <div className="bg-white border border-surface-200 rounded-none shadow-none p-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {CAREER_SUGGESTIONS[topDomain].map((career, i) => (
                  <div key={i} className="bg-surface-50 border border-surface-200 rounded-none p-2.5 flex items-center gap-2">
                    <div className="w-5 h-5 rounded-none bg-surface-200 flex items-center justify-center shrink-0">
        ...
        <div className="xl:col-span-5 space-y-6">
            ...
            <form onSubmit={handleCigiUpload} className="space-y-3.5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full text-sm font-medium text-surface-900 file:mr-3 file:py-1.5 file:px-3 file:rounded-none file:border-0 file:text-[10px] file:uppercase file:tracking-widest file:font-black file:bg-surface-200 file:text-surface-900 hover:file:bg-surface-300 file:cursor-pointer p-2 border border-surface-200 rounded-none bg-surface-50 focus:outline-none"
                />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 border border-surface-200 rounded-none text-sm font-medium bg-surface-50 text-surface-900 focus:ring-0 focus:border-surface-900 focus:bg-white outline-none"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full p-2 border border-surface-200 rounded-none text-sm font-medium bg-surface-50 text-surface-900 focus:ring-0 focus:border-surface-900 focus:bg-white outline-none resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full min-h-[38px] inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-surface-900 hover:bg-surface-800 disabled:bg-surface-500 text-white rounded-none uppercase tracking-widest text-[10px] font-black transition-colors border-none shadow-none cursor-pointer"
              >
                {isCigiUploading ? (
          ...
          <div className="bg-white border border-surface-200 rounded-none shadow-none p-5">
            ...
            {cigiResultsList.length === 0 ? (
              <div className="text-center py-6 text-surface-400 border border-dashed border-surface-200 rounded-none bg-surface-50">
              ...
              <div className="space-y-3 max-h-[350px] overflow-y-auto pr-1">
                {cigiResultsList.map((result) => (
                  <div key={result.id} className="p-3 bg-white border border-surface-200 rounded-none flex items-center justify-between gap-3 text-left">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className={`text-[10px] px-1.5 py-0.5 rounded-none font-black uppercase ${result.fileType === 'pdf' ? 'bg-rose-100 text-rose-700' : 'bg-blue-100 text-blue-700'}`}>
                          {result.fileType}
                        </span>
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      <a
                        ...
                        className="p-1.5 bg-surface-50 hover:bg-surface-100 border border-surface-200 rounded-none text-surface-900 transition-colors"
                        title="View document"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 bg-surface-50 hover:bg-rose-50 border border-surface-200 hover:border-rose-200 rounded-none text-surface-900 hover:text-rose-600 transition-colors cursor-pointer"
                        title="Delete result"
                      >
