...
const ResultsTab = ({
 ...
 <p className="text-sm font-black tracking-widest text-surface-900">No Sample Test History</p>
 ...
 className="mt-4 inline-flex items-center gap-1.5 px-5 py-2 bg-surface-900 text-white tracking-widest text-[10px] font-black rounded-[10px] hover:bg-surface-800 transition-colors border-none shadow-none"
 >
 ...
 <p className="text-[10px] text-surface-400 font-bold tracking-widest mb-1">Dominant Domain</p>
 <h4 className="text-xl font-black tracking-widest text-white">{topDomain}</h4>
 <p className="text-xs text-surface-400 mt-1.5">
 Your primary strength outcome. Click below to view the full detailed breakdown.
 </p>
 <div className="mt-3.5 flex justify-between items-center">
 <span className="text-[10px] tracking-widest font-black px-2.5 py-1 bg-white/10 rounded-[10px]">
 ...
 <p className="text-[10px] font-bold text-surface-500 tracking-widest">Top Strength Domains</p>
 {scores.slice(0, 4).map(([key, pct]) => (
 <div key={key} className="space-y-1">
 <div className="flex justify-between tracking-widest font-black text-[10px]">
 ...
 type="button"
 onClick={() => navigate('/sample-test')}
 className="w-full mt-2 inline-flex items-center justify-center gap-1.5 px-4 py-2 border border-surface-200 hover:border-surface-300 text-surface-900 tracking-widest text-[10px] font-black rounded-[10px] hover:bg-surface-50 transition-colors bg-white cursor-pointer"
 >
 ...
 <span className="text-[10px] tracking-widest font-bold text-surface-900">{career}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div>
 <label className="text-[10px] tracking-widest font-bold text-surface-600 block mb-1">
 ...
 required
 className="w-full text-sm font-medium text-surface-900 file:mr-3 file:py-1.5 file:px-3 file:rounded-[10px] file:border-0 file:text-[10px] file: file:tracking-widest file:font-black file:bg-surface-200 file:text-surface-900 hover:file:bg-surface-300 file:cursor-pointer p-2 border border-surface-200 rounded-[10px] bg-surface-50 focus:outline-none"
 />
 <p className="text-[10px] font-bold tracking-widest text-surface-400 mt-1">Allowed formats: JPG, JPEG, PNG, PDF (Max 5MB)</p>
 </div>

 <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
 <div>
 <label className="text-[10px] tracking-widest font-bold text-surface-600 block mb-1">Date Taken</label>
 <input
 type="date"
 value={cigiDate}
 ...
 <div>
 <label className="text-[10px] tracking-widest font-bold text-surface-600 block mb-1">Time Taken</label>
 <input
 type="time"
 value={cigiTime}
 ...
 <div>
 <label className="text-[10px] tracking-widest font-bold text-surface-600 block mb-1">Remarks / Note</label>
 <textarea
 ...
 className="w-full min-h-[38px] inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-surface-900 hover:bg-surface-800 disabled:bg-surface-500 text-white rounded-full tracking-widest text-[10px] font-black transition-colors border-none shadow-none cursor-pointer"
 >
 {isCigiUploading ? (
 ...
 <p className="text-[10px] font-bold tracking-widest">No result files uploaded yet.</p>
 </div>
 ) : (
 ...
 <span className={`text-[10px] px-1.5 py-0.5 rounded-[10px] font-black ${result.fileType === 'pdf' ? 'bg-rose-100 text-rose-700' : 'bg-blue-100 text-blue-700'}`}>
 {result.fileType}
 </span>
 ...
 <p className="text-[10px] text-surface-400 font-bold tracking-widest mt-0.5">
