...
const HeroHeader = ({
 ...
 return (
 <div className="bg-white border border-surface-200 rounded-[10px] shadow-square-light overflow-hidden">
 {/* Top accent strip */}
 ...
 <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-[10px] bg-emerald-500 border-2 border-white flex items-center justify-center">
 ...
 <h1 className="text-xl sm:text-2xl font-black text-surface-950 tracking-widest mt-1">
 ...
 {profile.grade && (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-[10px] bg-surface-100 text-surface-900 font-bold tracking-widest text-[10px]">
 <GraduationCap className="w-3 h-3" /> {profile.grade}
 </span>
 )}
 {profile.schoolName && (
 <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-[10px] bg-surface-100 text-surface-900 font-bold tracking-widest text-[10px] max-w-[180px] truncate">
 ...
 <span className="text-[10px] text-surface-500 font-bold tracking-widest">Profile completion</span>
 ...
 <div
 className="h-full bg-brand rounded-[10px] transition-all duration-700"
