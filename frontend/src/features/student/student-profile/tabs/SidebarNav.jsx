  ...
  return (
    <>
      ...
      <nav className="hidden lg:flex flex-col gap-0.5 p-1.5 bg-white border border-surface-200 rounded-none shadow-none sticky top-24">
        {TABS.map(tab => {
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-2.5 px-3 min-h-[44px] rounded-none text-xs font-bold uppercase tracking-widest transition-all duration-150 group cursor-pointer ${isActive
            ...
            >
              ...
              {badge !== null && badge !== 0 && (
                <span className={`text-[10px] font-black px-1.5 min-w-[20px] h-5 rounded-none flex items-center justify-center ${isActive
        ...
        <div className="mt-2 mx-1 p-3 bg-surface-50 border border-surface-200 rounded-none">
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  {badge !== null && badge > 0 && (
                    <span className="absolute -top-1.5 -right-2 text-[10px] font-black px-1 min-w-[14px] h-3.5 rounded-none bg-surface-900 text-white flex items-center justify-center">
                      {badge}
                    </span>
                  )}
                </div>
                ...
                {isActive && (
                  <span className="absolute top-0 left-1/2 -translate-x-1/2 w-6 h-0.5 bg-surface-900 rounded-none" />
                )}
              </button>
            );
          })}
