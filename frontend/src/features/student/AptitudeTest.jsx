...
export default function AptitudeTest({ onFinishTest }) {
 ...
 className="px-5 py-2.5 bg-white border border-surface-200 hover:border-surface-900 hover:bg-surface-50 text-surface-900 rounded-full font-black text-[10px] tracking-widest transition-colors flex items-center gap-2 cursor-pointer shadow-none w-full md:w-auto justify-center"
 >
 ...
 disabled={isClaiming}
 className="w-full py-3.5 sm:py-4 bg-surface-900 hover:bg-surface-800 text-white font-black text-[10px] tracking-widest rounded-full transition-all flex items-center justify-center gap-2 cursor-pointer shadow-none border-none disabled:opacity-70 disabled:cursor-not-allowed disabled:scale-100"
 >
 {isClaiming ? (
 <>
 ...
 <p className="text-[10px] font-bold tracking-widest text-surface-500 text-center mt-3 flex items-center justify-center gap-1">
 ...
 <h4 className="font-black text-surface-900 text-[10px] tracking-widest">
 ...
 <div className="flex justify-between text-[10px] font-bold text-surface-500 tracking-widest">
 <span>{label}</span>
