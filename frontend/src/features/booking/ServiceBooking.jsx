...
export default function ServiceBooking({ preselectedAdvisorId, clearPreselectedAdvisor }) {
    ...
    if (!enablePsychology && !enableCareerMentoring && !isRescheduleParam) {
        return (
            <div className="min-h-[75vh] flex flex-col items-center justify-center text-center px-4 py-16 bg-surface-50 font-sans select-none">
                <div className="max-w-md w-full bg-white border border-surface-200 p-8 rounded-[8px] shadow-sm space-y-6 animate-in fade-in zoom-in-95 duration-500">
                    <div className="w-16 h-16 bg-surface-100 border border-surface-200 rounded-[8px] flex items-center justify-center mx-auto text-surface-900 shadow-sm">
                    ...
                    <div className="space-y-2">
                        <span className="text-sm bg-surface-900 text-white px-3 py-1 rounded-[8px] font-bold w-fit mx-auto block">
                            System Notice
                        </span>
                    ...
                    <div className="pt-4 border-t border-surface-200 flex flex-col sm:flex-row gap-3 justify-center items-center">
                        <button
                            ...
                            className="px-6 py-3 min-h-[48px] bg-surface-900 hover:bg-surface-800 text-white text-sm font-semibold rounded-[8px] transition-all cursor-pointer shadow-none w-full sm:w-auto text-center border-none"
                        >
                            Home Page
                        </button>
                        <button
                            ...
                            className="px-6 py-3 min-h-[48px] bg-white border border-surface-200 hover:bg-surface-50 text-surface-900 text-sm font-semibold rounded-[8px] transition-all cursor-pointer w-full sm:w-auto text-center"
                        >
                            Take Sample Test
                        </button>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-8 sm:space-y-10">
                ...
                <div id="booking-console" className="space-y-6 sm:space-y-8 w-full mt-6">
                    ...
                    {bookingStep === 'success' ? (
                        ...
                        <div className="p-6 sm:p-10 bg-white border border-surface-200 rounded-[8px] max-w-2xl mx-auto shadow-sm space-y-6 text-center animate-in fade-in duration-300">
                            <style>{`
 ...
 `}</style>
                            ...
                            <div className="w-20 h-20 bg-surface-50 border border-surface-200 rounded-[8px] flex items-center justify-center mx-auto text-surface-900 shadow-sm animate-checkmark-circle">
                            ...
                            <div className="space-y-2 animate-scale-pop">
                                <span className="text-sm bg-surface-900 text-white border border-surface-900 px-3 py-1 rounded-[8px] font-semibold w-fit mx-auto block">
                            ...
                            <div className="bg-surface-50 border border-surface-200 rounded-[8px] p-5 text-left space-y-4 shadow-sm animate-card-fade">
                                ...
                                {bookingMode === 'ONLINE' && !rescheduleSession && (
                                    <div className="pt-4 border-t border-surface-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white p-4 rounded-[8px] border border-surface-200 mt-2">
                                        <div>
                                ...
                                {rescheduleSession ? (
                                    ...
                                    <>
                                        <button
                                            ...
                                            className="px-6 py-3 bg-white border border-surface-200 text-surface-900 hover:bg-surface-50 text-sm font-semibold rounded-[8px] transition cursor-pointer w-full sm:w-auto flex items-center justify-center gap-2"
                                        >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                            ...
                            <div className="lg:col-span-8 text-left min-h-[380px] relative">
                                    ...
                                    <div className="space-y-6 animate-in fade-in duration-300">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            {bookingMode === 'DOOR_STEP' && (
                                                <div className="space-y-4 p-0 sm:p-5 bg-transparent sm:bg-surface-50 border-0 sm:border border-surface-200 rounded-[8px] animate-in fade-in slide-in-from-top-2 duration-300 text-left">
                                                    ...
                                                    <div className="space-y-1.5 text-left relative">
                                                        ...
                                                        <div className="flex flex-col sm:flex-row gap-2">
                                                            <input
                                                                ...
                                                                className="flex-1 min-w-0 px-3.5 py-2.5 bg-white border border-surface-200 text-sm font-medium text-surface-900 outline-none focus:border-surface-900 rounded-[8px] transition"
                                                                onKeyDown={(e) => {
                                                                    if (e.key === 'Enter') {
                                                                        e.preventDefault();
                                                        ...
                                                        {clientSearchResults.length > 0 && (
                                                            <div className="absolute left-0 right-0 mt-1 bg-white border border-surface-200 rounded-[8px] max-h-40 overflow-y-auto z-50 shadow-sm divide-y divide-surface-100">
                                        ...
                                        {!(bookingMode === 'DOOR_STEP' && (!bookingForm.clientLatitude || !bookingForm.clientLongitude)) ? (
                                            <div className="space-y-2 pt-4 border-t border-surface-200 animate-in fade-in duration-300">
                                                ...
                                                <div className="p-0 sm:p-4 bg-transparent sm:bg-surface-50 border-0 sm:border border-surface-200 rounded-[8px]">
                                                    <DateTimePicker
                                            ...
                                            <div className="p-4 sm:p-6 border border-dashed border-surface-200 rounded-[8px] bg-surface-50 text-surface-600 text-center font-medium text-sm mt-4">
                                        ...
                                        {(selectedDate || isAdvisorLocked) && (
                                            <div ref={step2Ref} className="space-y-3 pt-6 border-t border-surface-200 animate-in fade-in slide-in-from-top-2 duration-300">
                                                ...
                                                {isAdvisorLocked && selectedAdvisor ? (
                                                    <div className="p-4 border border-surface-900 bg-surface-50 shadow-sm rounded-[8px]">
                                                    ...
                                                    <div className="space-y-3">
                                                        {(() => {
                                                            ...
                                                            return advisorsToRender.map((advisor) => {
                                                                ...
                                                                if (isSelected) {
                                                                    return (
                                                                        <div key={advisor.id} className="border-[2px] border-brand rounded-[8px] bg-white overflow-hidden animate-in fade-in slide-in-from-top-2 text-left shadow-sm relative">
                                                                            ...
                                                                            <div className="p-4 sm:p-5 bg-white">
                                                                                ...
                                                                                <div className="flex items-center gap-3">
                                                                                    <button
                                                                                        ...
                                                                                        className="flex-1 py-3 bg-white border-2 border-surface-200 text-surface-900 font-semibold text-sm rounded-[8px] hover:border-surface-900 hover:bg-surface-50 transition-colors text-center cursor-pointer shadow-none"
                                                                                    >
                                                                                        View Profile
                                                                                    </button>
                                                                                    <button
                                                                                        ...
                                                                                        className="flex-1 py-3 bg-surface-900 text-white font-semibold text-sm rounded-[8px] hover:bg-black transition-colors text-center border-2 border-surface-900 cursor-pointer shadow-sm"
                                                                                    >
                                                                                        Book Now
                                                                                    </button>
                                                                                </div>
                                                                ...
                                                                return (
                                                                    <div
                                                                        ...
                                                                        className={`p-4 sm:p-5 border-[2px] rounded-[8px] transition ${!isAvailable
                                        ...
                                        <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-8 mt-4 border-t border-surface-200">
                                            {rescheduleSession ? (
                                                ...
                                                <button
                                                    ...
                                                    className="px-6 py-2.5 min-h-[48px] bg-surface-900 text-white font-semibold text-sm rounded-[8px] transition hover:bg-black disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center border-none shadow-none w-full sm:w-auto"
                                                >
                                                    Account & Payment
                                                </button>
                                            )}
                                ...
                                {bookingStep === 'payment' && (
                                    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                                        ...
                                        {user && (
                                            <div className="bg-surface-50 border border-surface-200 rounded-[8px] p-4 flex items-center justify-between gap-3 animate-in fade-in duration-300 shadow-sm">
                                                ...
                                                <span className="shrink-0 text-sm font-semibold bg-surface-900 text-white px-2.5 py-1 rounded-[8px]">
                                                    ✓ Authenticated
                                                </span>
                                            </div>
                                        )}
                                        ...
                                        {bookingMode === 'DOOR_STEP' && (
                                            <div className="p-0 sm:p-4 bg-transparent sm:bg-surface-50 border-0 sm:border border-surface-200 rounded-[8px] text-left space-y-1 animate-in fade-in duration-300">
                                                ...
                                                {(() => {
                                                    ...
                                                    if (distance !== null) {
                                                        return (
                                                            <span className="inline-block mt-1.5 font-semibold text-surface-900 bg-surface-50 border border-surface-200 px-2 py-0.5 rounded-[8px] text-sm">
                                        ...
                                        {bookingMode === 'OFFLINE' && selectedAdvisor && (
                                            <div className="p-0 sm:p-4 bg-transparent sm:bg-surface-50 border-0 sm:border border-surface-200 rounded-[8px] text-left space-y-1.5 animate-in fade-in duration-300">
                                                <span className="font-semibold text-surface-900 block text-sm">
                                        ...
                                        <div className="pt-4 border-t border-surface-200 mt-6">
                                            ...
                                            <form onSubmit={handlePaymentSubmit} className="space-y-6">
                                                ...
                                                <div className="p-4 bg-surface-50 border border-surface-200 rounded-[8px] space-y-4">
                                                    <div className="flex flex-col sm:flex-row items-center gap-4 text-left">
                                                        <div className="w-12 h-12 bg-white border border-surface-200 rounded-[8px] flex items-center justify-center shrink-0 shadow-sm">
                            ...
                            <div className="lg:col-span-4 lg:sticky lg:top-20 text-left">
                                ...
                                <button
                                    ...
                                    className="flex lg:hidden items-center justify-between w-full bg-surface-50 border border-surface-200 p-3 rounded-[8px] text-left shadow-none mb-3 hover:bg-surface-100 transition cursor-pointer"
                                >
                                    <span className="text-sm font-semibold text-surface-900 flex items-center gap-2">
                                        <span>Booking Summary</span>
                                        {selectedAdvisor && (
                                            <span className="text-xs bg-surface-900 text-white px-2 py-0.5 rounded-[8px] font-semibold ">
                                ...
                                <div className={`space-y-5 ${showSummary ? 'block' : 'hidden'} lg:block`}>
                                    ...
                                    <div className="space-y-4 text-sm font-bold ">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-xs text-surface-500 font-bold block mt-0.5 bg-white border border-surface-200 rounded-[8px] px-2 py-0.5 w-fit">
                                        ...
                                        <div>
                                            ...
                                            {selectedDate && selectedTime ? (
                                                <div className="space-y-1 bg-white border border-surface-200 p-2 rounded-[8px] text-left">
                                        ...
                                        <div>
                                            ...
                                            {selectedAdvisor ? (
                                                <div className="bg-white border border-surface-200 p-2.5 rounded-[8px] text-left">
                                        ...
                                        <div className="pt-3 border-t border-surface-200 space-y-2 text-left">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className="flex-1 px-3 py-1.5 bg-white border border-surface-200 rounded-[8px] text-sm font-bold outline-none focus:border-surface-900 transition"
                                                />
                                                {appliedDiscount > 0 ? (
                                                    <button
                                                        type="button"
                ...
                {showNoCounsellorsModal && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in duration-200">
                        <div className="bg-white border border-surface-200 rounded-[8px] w-full max-w-sm p-6 shadow-sm space-y-4 text-center animate-in zoom-in-95 duration-200">
