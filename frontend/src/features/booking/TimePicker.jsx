...
export default function TimePicker({
  ...
  return (
    <div className="bg-white border border-slate-200/90 rounded-2xl p-4 sm:p-6 shadow-xs space-y-5 text-left">
      ...
      <div className="bg-gradient-to-r from-slate-50 via-teal-50/30 to-slate-50 border border-slate-200/90 rounded-xl p-3 flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          {isToday ? (
            <span className="px-2.5 py-0.5 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-extrabold text-[10px] uppercase tracking-wider rounded-md shadow-xs flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
              Today
            </span>
          ) : (
            <span className="px-2.5 py-0.5 bg-slate-900 text-[#00c9d6] font-bold text-[10px] uppercase tracking-wider rounded-md shadow-xs flex items-center gap-1">
              <Calendar className="w-3 h-3 text-[#00c9d6]" />
              Selected
            </span>
          )}
