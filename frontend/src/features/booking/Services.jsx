  ...
  return (
    <section id="services" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 text-zinc-900 text-left relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch w-full">
        ...
        <div
          id="card-career"
          className="relative bg-white/70 backdrop-blur-2xl border-neon-glow border-neon-glow-hover p-6 sm:p-8 md:p-12 flex flex-col justify-between space-y-8 select-none group rounded-2xl sm:rounded-[2rem] transition-all duration-700 min-h-[300px] md:min-h-[360px] overflow-hidden"
        >
      ...
      <div id="our-experts" className="mt-12 md:mt-16 space-y-8">
        ...
        <div className="bg-white border-neon-glow border-neon-glow-hover p-3 sm:p-4 rounded-2xl sm:rounded-[2rem] flex flex-col xl:flex-row xl:items-center gap-3 sm:gap-4 w-full">
          {/* Search Box */}
