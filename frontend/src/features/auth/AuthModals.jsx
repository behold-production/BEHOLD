  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-[115] flex items-center justify-center p-4 sm:p-6 overflow-y-auto overscroll-contain" role="dialog" aria-modal="true" aria-labelledby="auth-modal-title" onClick={authStep === 'details' ? undefined : onClose}>
        <div className="relative w-full max-w-md bg-white shadow-sm border-slate-200 shadow-md rounded-2xl shadow-2xl max-h-full overflow-y-auto animate-modal-in border border-zinc-200 m-auto flex flex-col" onClick={(e) => e.stopPropagation()}>
          ...
          {rejectionReason ? (
            <div className="p-6 space-y-4">
              <div className="bg-rose-50 border border-rose-200 p-4 rounded-xl space-y-3">
                ...
                <div className="bg-white shadow-sm border-slate-200 shadow-md border border-rose-100 p-3 rounded-xl">
              ...
              <button onClick={() => setRejectionReason(null)} className="w-full py-3.5 bg-white hover:bg-slate-50 text-slate-900 font-semibold text-sm rounded-xl transition-all cursor-pointer border border-[#00e5ff]/30">
                Return to Login
              </button>
            </div>
          ) : authStep === 'details' ? (
            ...
            <form onSubmit={handleDetailsSubmit} className="p-6 space-y-4">
              <div className="bg-white border border-slate-200 rounded-xl p-3.5 flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-[11px] text-slate-600">Only your verified details will be linked to your bookings.</p>
                </div>
              </div>
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 rounded-xl text-sm font-medium text-zinc-900 outline-none transition border ${
                      fieldErrors.name
                        ...
                        : 'bg-zinc-50 border-zinc-200 focus:bg-white shadow-sm border-slate-200 shadow-md focus:border-brand focus:ring-2 focus:ring-brand/20'
                    }`}
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      autoFocus
                      className="w-full pl-16 pr-4 py-3 bg-zinc-50 border border-zinc-200 rounded-lg text-sm text-zinc-900 focus:bg-white shadow-sm border-slate-200 shadow-md focus:border-brand focus:ring-2 focus:ring-brand/20 outline-none transition-all"
                    />
                  </div>
                </div>
              )}
