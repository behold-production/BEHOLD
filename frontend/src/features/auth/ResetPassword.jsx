...
export default function ResetPassword() {
 ...
 <div>
 <label className="block text-xs font-bold text-zinc-700 tracking-wider mb-2">New Password</label>
 <input
 type="password"
 value={password}
 ...
 <div>
 <label className="block text-xs font-bold text-zinc-700 tracking-wider mb-2">Confirm Password</label>
 <input
 type="password"
