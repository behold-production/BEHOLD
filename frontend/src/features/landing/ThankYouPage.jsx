          ...
          {isLoading ? (
            ...
            <>
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-gradient-to-r from-[#bcf4f8]/30 to-[#d7f9fb]/20 border border-[#bcf4f8]/60">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 text-sm sm:text-base">{bookingData?.advisorName || 'Assigned Psychologist'}</h3>
              ...
              {bookingData?.meetLink && (
                <div className="p-4 rounded-2xl bg-indigo-50/70 border border-indigo-200/80 space-y-2.5">
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold rounded-xl transition shadow-sm"
                  >
