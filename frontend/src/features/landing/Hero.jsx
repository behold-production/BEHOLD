...
export default function Hero({ setView, navigateToSection, siteSettings }) {
 ...
 className="text-brand font-bold text-sm tracking-widest mb-4"
 >
 {settings.heroTopSub}
 </motion.p>
 )}
 ...
 className="px-6 py-4 sm:py-5 bg-[#00E5FF] text-black font-black tracking-widest rounded-2xl transition-all flex items-center justify-center w-full sm:w-auto hover:bg-[#00cce6] hover:scale-105 active:scale-95 text-[15px] cursor-pointer shadow-[0_0_25px_rgba(0,229,255,0.5)] border-none"
 >
 {slide.btn1Text}
 </button>
 )}
 ...
 className="px-6 py-4 sm:py-5 bg-[#2C2E3E] text-white font-black tracking-widest rounded-2xl transition-all flex items-center justify-center border border-white/10 w-full sm:w-auto hover:bg-[#383a4c] hover:scale-105 active:scale-95 text-[15px] cursor-pointer shadow-lg"
 >
 {slide.btn2Text}
 </button>
 )}
