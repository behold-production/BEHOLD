        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left space-y-5 max-w-2xl mx-auto md:mx-0 transition-transform duration-500">
          ...
          <div className="relative leading-none flex flex-col items-center md:items-start group">
            ...
            <div className="relative inline-block mt-3 sm:mt-6">
              <span className="font-rough text-[#00c9d6] text-[108px] xs:text-[116px] sm:text-[130px] md:text-[140px] lg:text-[155px] font-normal tracking-tight [word-spacing:0.25em] block leading-[0.95] drop-shadow-sm select-none animate-hero-pulse">
