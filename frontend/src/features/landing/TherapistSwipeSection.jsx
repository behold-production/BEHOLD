        ...
        <div className="relative z-20 -mt-3.5 sm:-mt-4 bg-white rounded-t-[20px] sm:rounded-t-[22px] rounded-b-[24px] sm:rounded-b-[26px] p-3 sm:p-5 flex-1 flex flex-col justify-between space-y-2 sm:space-y-3 overflow-hidden">
          ...
          <div className="pt-1.5 sm:pt-2 flex items-center justify-between gap-1.5 sm:gap-2 border-t border-slate-100 shrink-0">
            <div className="text-left shrink-0">
              <span className="text-[8.5px] sm:text-[10px] font-semibold text-slate-600 block tracking-wider">Next available</span>
              <span className={`text-[10px] sm:text-xs font-semibold block mt-0.5 whitespace-nowrap ${isUnavailable ? 'text-slate-600' : isAvailToday ? 'text-emerald-600' : 'text-slate-900'}`}>
                {nextAvail}
              </span>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
              <button
                ...
                className="px-2 sm:px-3.5 py-1.5 sm:py-2 border border-slate-300 hover:border-slate-200 text-slate-800 hover:bg-white hover:text-slate-900 rounded-xl text-[9.5px] sm:text-xs font-bold transition cursor-pointer whitespace-nowrap hover-scale-btn shadow-xs"
              >
                View Profile
              </button>
              <button
                ...
                className="bg-[#00e5ff] hover:bg-[#00b2be] text-white font-extrabold text-[9.5px] sm:text-xs tracking-wider px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer whitespace-nowrap hover-scale-btn"
              >
                Book Session
              </button>
            </div>
            ...
            {[
              ...
              <button
                ...
                className={`px-3.5 py-1.5 rounded-xl text-[11px] sm:text-xs font-bold whitespace-nowrap shrink-0 transition-all duration-300 cursor-pointer ${selectedRole === role.id
                  ? 'bg-[#00e5ff] text-white shadow-md border border-[#00e5ff]'
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center justify-center">
        ...
        {loading ? (
          ...
          <div className="w-full max-w-xl mx-auto bg-white/90 backdrop-blur-md rounded-xl border border-dashed border-slate-300 p-8 sm:p-12 text-center shadow-sm my-6">
            <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 border border-[#00e5ff]/40 shadow-xs">
            ...
            <button
              ...
              className="px-8 py-3 bg-white hover:bg-[#00e5ff] hover:text-white text-slate-900 font-semibold text-xs tracking-wider rounded-xl transition shadow-md border-none cursor-pointer hover-scale-btn"
            >
          ...
          <>
            ...
            <div className="mt-8 sm:mt-12 flex flex-col items-center text-center space-y-5 max-w-2xl mx-auto px-4 sm:px-6">
              ...
              <button
                onClick={handleConnectClick}
                className="bg-white hover:bg-[#00e5ff] hover:text-white text-slate-900 font-bold text-xs px-6 py-2.5 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer flex items-center justify-center border-none hover-scale-btn mt-1"
              >
                Let's Connect
              </button>
            </div>
