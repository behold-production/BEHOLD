...
export default function Faq() {
    ...
    return (
        <motion.section
            ...
            className="py-8 md:py-14 px-6 bg-transparent"
        >
                ...
                <div className="space-y-4">
                    {faqs.map((faq, idx) => {
                        ...
                        return (
                            <div
                                key={idx}
                                className={`bg-white rounded-3xl border border-slate-200/60 shadow-sm p-0 transition-all duration-300 ${isOpen ? 'bg-brand/5' : ''}`}
                            >
                                <button
                                    type="button"
