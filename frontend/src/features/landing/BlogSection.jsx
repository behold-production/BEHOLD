      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 reveal-on-scroll">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-white hover:bg-[#00e5ff] hover:text-white text-slate-900 font-semibold text-xs tracking-wider rounded-full transition-all border-none cursor-pointer shadow-sm hover-scale-btn"
          >
