      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 reveal-on-scroll">
          ...
          <h2 id="blog-title" className="text-3xl sm:text-4xl md:text-5xl font-sans font-semibold text-[#0f172a] mb-4 tracking-tight leading-tight">
            Guidance for Your Journey<span className="text-[#00e5ff] drop-shadow-[0_0_8px_rgba(0,201,214,0.6)] font-semibold">.</span>
          </h2>
          ...
          <button
            ...
            className="px-6 py-2.5 bg-[#0f172a] hover:bg-[#00e5ff] hover:text-slate-950 text-white font-semibold text-xs tracking-wider rounded-full transition-all border-none cursor-pointer shadow-sm hover-scale-btn"
          >
