          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#00e5ff] hover:bg-[#00b2be] text-white font-semibold text-sm py-3.5 rounded-full shadow-md hover-scale-btn transition-all duration-200 cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2 border-none mt-1"
              >
                {loading ? (
