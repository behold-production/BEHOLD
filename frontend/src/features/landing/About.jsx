...
export default function About({ enablePsychology = true, enableCareerMentoring = true, siteSettings }) {
  ...
  return (
    <>
      ...
      />
      <section id="about" className="relative py-12 sm:py-20 text-white select-none overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-6 items-stretch">
            ...
            <div className="lg:col-span-7 bg-[#0f172a]/90 backdrop-blur-md rounded-[2.5rem] p-6 sm:p-10 border border-slate-700/80 shadow-md flex flex-col justify-between relative overflow-hidden reveal-on-scroll reveal-scale-in">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-4xl font-normal text-white tracking-tight leading-tight font-serif">
              ...
              <div className="mt-6 sm:mt-8 pt-6 border-t border-slate-800 flex flex-wrap items-center gap-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#1e293b] border border-slate-700/60 text-xs font-medium text-slate-300">
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 to-slate-950 rounded-[2.5rem] p-6 sm:p-10 border border-slate-800 shadow-xl flex flex-col justify-between text-white relative overflow-hidden reveal-on-scroll reveal-scale-in reveal-delay-1">
              <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-[#00e5ff]/10 rounded-full blur-2xl pointer-events-none" />
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-2xl bg-[#0f172a]/10 border border-white/10 flex items-center justify-center mb-6">
            ...
            <div className="lg:col-span-7 bg-[#0f172a]/90 backdrop-blur-md rounded-[2.5rem] p-6 sm:p-10 border border-slate-700/80 shadow-md flex flex-col sm:flex-row items-start sm:items-center justify-start gap-6 relative overflow-hidden reveal-on-scroll reveal-scale-in reveal-delay-2">
              <div className="relative z-10 flex flex-col gap-1">
                ...
                <p className="mt-1 text-sm text-slate-400 font-medium max-w-xs">
                  {stats[1].label}
                </p>
              </div>
            </div>
            ...
            <div className="md:col-span-1 lg:col-span-4 bg-[#0f172a] p-8 rounded-[2.5rem] border border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col justify-between group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
              <Heart className="w-6 h-6 text-[#00e5ff] mb-4" />
              <div>
                <span className="block text-4xl sm:text-5xl font-semibold text-white font-sans tracking-tight mb-2 group-hover:text-[#00e5ff] transition-colors">
                  {stats[2].value}
                </span>
            ...
            <div className="md:col-span-1 lg:col-span-3 primary-cyan-gradient text-slate-950 font-black filter-glow border-none p-8 rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden group reveal-on-scroll reveal-scale-in reveal-delay-4">
              ...
              <div className="mt-8 relative z-10">
                <button
                  ...
                  className="w-full flex items-center justify-between py-3 px-5 bg-[#0f172a]/10 hover:bg-[#0f172a]/20 rounded-2xl text-xs font-semibold uppercase tracking-widest text-white transition-colors cursor-pointer group/btn"
                >
          ...
          {settings.aboutCards && settings.aboutCards.length > 0 && (
            <div className="mt-20 sm:mt-32">
              <div className="text-center mb-12">
                ...
                <h3 className="text-2xl sm:text-4xl font-sans font-semibold uppercase text-white tracking-tight leading-none">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                {settings.aboutCards.map((card, idx) => (
                  <div key={idx} className="bg-[#0f172a]/80 backdrop-blur-md border border-slate-700/90 p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 group hover:-translate-y-1">
                    <div className="w-12 h-12 rounded-2xl bg-[#1e293b] flex items-center justify-center mb-6 group-hover:bg-[#00e5ff]/10 transition-colors">
                    ...
                    <h4 className="text-lg font-semibold text-white uppercase tracking-wide mb-3">{card.title}</h4>
