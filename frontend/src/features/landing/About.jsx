      ...
      <section id="about" className="relative py-12 sm:py-20 text-slate-900 select-none overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 lg:gap-6 items-stretch">
            ...
            <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 to-slate-950 rounded-[2.5rem] p-6 sm:p-10 border border-slate-100 shadow-xl flex flex-col justify-between text-slate-900 relative overflow-hidden reveal-on-scroll reveal-scale-in reveal-delay-1">
              ...
              <div className="relative z-10">
                ...
                <div className="text-4xl sm:text-5xl font-black tracking-tight text-slate-900 font-sans">
                  {stats[0].value}
                </div>
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <p className="text-xs text-slate-600">Validated through clinical outcomes &amp; student career achievements.</p>
              </div>
            </div>
            ...
            <div className="md:col-span-2 lg:col-span-5 h-72 sm:h-80 lg:h-auto rounded-[2.5rem] overflow-hidden bg-white shadow-xl relative group hover-scale-card reveal-on-scroll reveal-scale-in reveal-delay-3">
              <img
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h4 className="text-sm font-semibold uppercase tracking-wider text-slate-900">Safe & Inspiring Environment</h4>
                </div>
                <p className="text-xs text-slate-700 font-medium">Personalized in-person & doorstep counseling.</p>
              </div>
            </div>
            ...
            <div className="md:col-span-1 lg:col-span-4 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] flex flex-col justify-between group hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
              ...
              <div>
                <span className="block text-4xl sm:text-5xl font-semibold text-slate-900 font-sans tracking-tight mb-2 group-hover:text-[#00e5ff] transition-colors">
                  {stats[2].value}
                </span>
            ...
            <div className="md:col-span-1 lg:col-span-3 bg-[#00e5ff] text-slate-900 font-bold hover:bg-[#00b2be] transition-colors shadow-sm border-none p-8 rounded-[2.5rem] shadow-2xl flex flex-col justify-between relative overflow-hidden group reveal-on-scroll reveal-scale-in reveal-delay-4">
              ...
              <div className="mt-8 relative z-10">
                <button
                  ...
                  className="w-full flex items-center justify-between py-3 px-5 bg-white/10 hover:bg-white/20 rounded-2xl text-xs font-semibold uppercase tracking-widest text-slate-900 transition-colors cursor-pointer group/btn"
                >
                ...
                {settings.aboutCards.map((card, idx) => (
                  <div key={idx} className="bg-white/80 backdrop-blur-md border border-slate-200/90 p-8 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 group hover:-translate-y-1">
                    <div className="w-12 h-12 rounded-2xl bg-slate-50 flex items-center justify-center mb-6 group-hover:bg-[#00e5ff]/10 transition-colors">
                      <span className="text-lg font-semibold uppercase text-slate-600 font-sans group-hover:text-[#00e5ff] tracking-wide">{String(idx + 1).padStart(2, '0')}</span>
                    </div>
