...
const PrivacyPolicy = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F5] font-sans selection:bg-[#00e5ff]/30">
      <SEO 
      ...
      {/* Header Section */}
      <section className="bg-[#00e5ff] text-zinc-950 py-16 md:py-24 px-6 relative overflow-hidden">
