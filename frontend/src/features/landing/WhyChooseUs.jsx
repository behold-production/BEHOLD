      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 reveal-on-scroll reveal-slide-left">
            <div className="relative w-full min-h-[460px] sm:min-h-[520px] rounded-xl overflow-hidden shadow-lg flex flex-col justify-end p-6 sm:p-10 border border-[#00e5ff]/40 group hover-scale-card">
              ...
              <div className="relative z-10 space-y-4">
                <span className="inline-flex items-center gap-2 text-[11px] font-semibold text-[#00e5ff] tracking-widest uppercase">
                  <span className="w-4 h-px bg-[#00e5ff]/60 inline-block" />
                  {siteSettings?.servicesSectionSub || 'Unfold With Behold'}
                  <span className="w-4 h-px bg-[#00e5ff]/60 inline-block" />
                </span>

                <h2 className="text-2xl sm:text-4xl lg:text-5xl font-sans font-semibold text-slate-900 tracking-tight leading-[1.02]">
                ...
                <p className="text-xs sm:text-sm text-slate-900/90 leading-relaxed font-medium max-w-lg">
                ...
                <div className="flex flex-wrap items-center gap-3 pt-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-white/10 hover:bg-white/20 hover-scale-btn text-slate-900 font-semibold text-xs rounded-full transition-all border border-white/30 backdrop-blur-md cursor-pointer"
                  >
          ...
          <div className="lg:col-span-6 grid grid-cols-2 gap-4 sm:gap-6 pt-6 lg:pt-0 items-stretch content-start reveal-on-scroll reveal-slide-right reveal-delay-2">
            ...
            <div className="p-5 sm:p-7 rounded-xl bg-white text-slate-900 border border-[#00e5ff]/30 shadow-md flex flex-col justify-between min-h-[208px] sm:min-h-[240px] space-y-3 reveal-on-scroll reveal-scale-in reveal-delay-4">
