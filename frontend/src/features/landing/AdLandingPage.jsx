  ...
  return (
    <div className="min-h-screen bg-mesh-gradient text-[#0f172a] font-sans antialiased overflow-x-hidden flex flex-col justify-between">
      ...
      <section className="relative pt-8 sm:pt-14 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-96 h-96 bg-[#00e5ff]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
            ...
            <div className="relative w-full max-w-[310px] sm:max-w-[330px] rounded-[36px] bg-slate-950 p-2.5 shadow-[0_25px_60px_-15px_rgba(0,201,214,0.25)] border-[3px] border-slate-800 ring-1 ring-[#00e5ff]/40 transition-transform duration-300 hover:scale-[1.01]">
              ...
              >
                ...
                >
                  ...
                  >
                    <div
                      className="h-full bg-gradient-to-r from-[#3a0ca3] to-[#00e5ff] rounded-full transition-all duration-100"
                  ...
                  <div className="flex items-center justify-between text-white text-[11px] font-semibold">
                    <div className="flex items-center gap-2">
                      <button
                        type="button"
                        onClick={handleTogglePlay}
                        className="hover:text-[#00e5ff] transition cursor-pointer"
                      >
          ...
          <div className="lg:col-span-7 space-y-6 text-left order-1 lg:order-2">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-[#3a0ca3] bg-[#00e5ff]/10 px-3.5 py-1 rounded-md border border-[#00e5ff]/25 shadow-2xs">
                      ...
                      <div className="bg-slate-50/90 border border-slate-200/80 rounded-xl p-3 shadow-2xs">
                        ...
                        {advisor.bio && advisor.bio.length > 50 && (
                          <button
                            ...
                            className="text-[10px] font-semibold text-[#00e5ff] hover:text-[#3a0ca3] cursor-pointer mt-1 inline-block bg-transparent border-none p-0"
                          >
