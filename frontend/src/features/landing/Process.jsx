      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-14 text-center">
          <button
            ...
            className="px-8 py-3.5 bg-white hover:bg-[#00e5ff] hover:text-white text-slate-900 font-semibold text-xs tracking-wider rounded-full transition-all cursor-pointer border-none shadow-sm inline-flex items-center gap-2 hover-scale-btn"
          >
