      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <h2 id="process-title" className="text-3xl sm:text-5xl font-sans font-semibold text-[#0f172a] mb-4 tracking-tight leading-none">
            Four Steps To Clarity<span className="text-[#00e5ff] drop-shadow-[0_0_8px_rgba(0,201,214,0.8)] font-semibold">.</span>
          </h2>
            ...
            return (
              ...
              <div>
                <div className="flex items-center justify-between w-full mb-6">
                  <span className="text-4xl font-semibold text-[#0f172a] font-sans group-hover:text-[#00e5ff] transition-colors">
                    {step.num}
                  </span>
        ...
        <div className="mt-14 text-center">
          <button
            ...
            className="px-8 py-3.5 bg-[#0f172a] hover:bg-[#00e5ff] hover:text-slate-950 text-white font-semibold text-xs tracking-wider rounded-full transition-all cursor-pointer border-none shadow-sm inline-flex items-center gap-2 hover-scale-btn"
          >
