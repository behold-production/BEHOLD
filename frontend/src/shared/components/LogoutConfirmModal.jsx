...
export default function LogoutConfirmModal({ isOpen, onConfirm, onCancel, theme = 'dark' }) {
 ...
 {/* Modal card */}
 <div
 className={`relative z-10 w-full max-w-sm rounded-[10px] shadow-2xl animate-in zoom-in-95 duration-200 ${
 isDark
 ...
 {/* Warning icon */}
 <div className={`w-14 h-14 rounded-[10px] flex items-center justify-center mx-auto ${
 ...
 <h3 id="logout-confirm-title" className={`text-base font-bold font-header ${
 ...
 type="button"
 onClick={onCancel}
 className={`min-h-[44px] flex-1 py-2.5 rounded-full text-xs font-bold transition cursor-pointer border ${
 isDark
 ...
 type="button"
 onClick={onConfirm}
 className="min-h-[44px] flex-1 py-2.5 rounded-full text-xs font-bold transition cursor-pointer border-none bg-rose-600 hover:bg-rose-700 text-white flex items-center justify-center gap-1.5 shadow-md"
 >
