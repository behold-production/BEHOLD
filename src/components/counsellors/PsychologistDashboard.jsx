...
export default function PsychologistDashboard({ setView }) {
 ...
 <div className="space-y-6">
 {/* Stepper Indicators */}
 <div className="flex flex-wrap items-center justify-center sm:justify-between gap-x-2 gap-y-2 text-sm md:text-base font-black uppercase tracking-wider border-b border-zinc-850 pb-3 text-center">
 ...
 className="px-4.5 py-3 bg-brand hover:bg-brand-dark text-zinc-955 rounded-lg text-[13.5px] font-black uppercase tracking-widest transition cursor-pointer flex items-center gap-1 shadow-xs border-none font-extrabold"
 >
