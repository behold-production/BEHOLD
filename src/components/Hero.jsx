...
export default function Hero({ setView, navigateToSection }) {
  ...
  return (
    <section
      id="home"
      className="relative w-full py-8 lg:py-24 px-4 sm:px-6 text-zinc-900 text-left grid-bg overflow-hidden flex flex-col items-center justify-center min-h-[calc(100vh-72px)] select-none"
    >
      ...
      <div className="max-w-7xl xl:max-w-[1440px] 2xl:max-w-[1680px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 xl:gap-16 2xl:gap-24 items-center relative z-10">
        ...
        <div className="lg:col-span-6 flex flex-col justify-between lg:justify-start min-h-0 lg:min-h-[485px] space-y-8 lg:space-y-5 fade-in-up text-center lg:text-left items-center lg:items-start w-full">
          ...
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3.5 sm:gap-4 pt-2 w-full mt-auto">
            <button
          ...
          <div className="flex flex-row flex-wrap items-center justify-center lg:justify-between gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3 pt-4 sm:pt-6 border-t border-white/10 lg:border-zinc-200 w-full max-w-lg text-[11px] font-bold tracking-wider text-zinc-400 lg:text-zinc-500">
